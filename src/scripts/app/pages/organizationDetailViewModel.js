(function (eim) {
    ...
    eim.ViewModels.OrganizationDetailViewModel = function () {
        ...
        self.init = function () {
            ...
            self.loading();
            return eim.service.getMetabaseData(eim.config.OrganizationDetailUrl, {
                ...
                return eim.service.getMetabaseData(eim.config.OrganizationPriceListUrl, {
                    MAT_ID_: self.MAT_ID_()
                });
            }, showError).then(function (result) {
                self.prices(result);
                return eim.service.getMetabaseData(eim.config.OrganizationVendorListUrl, {
                    MAT_ID_: self.MAT_ID_()
                });
            }, showError).then(function (result) {
                self.vendors(result);
